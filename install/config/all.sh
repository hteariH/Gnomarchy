...
source "$GNOMARCHY_INSTALL/config/editor.sh"
source "$GNOMARCHY_INSTALL/config/dotfiles.sh"
source "$GNOMARCHY_INSTALL/config/hardware/all.sh"
source "$GNOMARCHY_INSTALL/config/theme.sh"
source "$GNOMARCHY_INSTALL/config/systemd.sh"
source "$GNOMARCHY_INSTALL/config/hooks.sh"
source "$GNOMARCHY_INSTALL/config/gnomarchy-ai-skill.sh"
